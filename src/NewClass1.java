 ...
 * @author bryancurt
 */
public class NewClass1 extends javax.swing.JPanel implements Runnable{
    ...
    public static void main(String[] arguments) throws IOException {
        ...
        panel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent me) { //Forest Gump
                ...
                if (bounds.contains(clicked)) {
                    try {
                        new BreserverBillet(0).setVisible(true); //lance l'interface de consultation
                        frame.dispose();
        ...
        panel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent me) { //La ligne verte
                ...
                if (bounds.contains(clicked)) {
                    try {
                        new BreserverBillet(1).setVisible(true); //lance l'interface de consultation
                        frame.dispose();
                    } catch (ClassNotFoundException ex) {
                        Logger.getLogger(Jclient.class.getName()).log(Level.SEVERE, null, ex);
                    } catch (SQLException ex) {
        ...
        panel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent me) { //coco
                ...
                if (bounds.contains(clicked)) {
                    try {
                        new BreserverBillet(2).setVisible(true); //lance l'interface de billet
                        frame.dispose();
                    } catch (ClassNotFoundException ex) {
                        Logger.getLogger(Jclient.class.getName()).log(Level.SEVERE, null, ex);
                    } catch (SQLException ex) {
